...
function getProductDetails(theParameter){
    return new Promise(resolve=>{
        const request = https.get(`https://osf-digital-backend-academy.herokuapp.com/api/products/product_search?id=${theParameter}&secretKey=$2a$08$EnHlurAo729FiqMtWlY1YumuY088oZf5gWlkKBMgvGcmtd4tKQEzi`, response=>{
